...
**1. Python:** Cleaned dataset + engineered features (dependency score, value tier, satisfaction flag)

**2. SQL:** Segmentation queries answering all 5 key questions above

**3. Power BI:** Four-panel founder dashboard as described in scope

**4. Playbook:** Promo sunset plan + ideal customer profile

**5. Summary:** A concise executive summary (max 1 page) of findings and recommendations
